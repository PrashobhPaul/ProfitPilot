...
ADD_750 = [
    ...
    "URBANCO", "HYUNDAI", "TATACAP", "TMPV", "PACEDIGITK", "ARE&M",
...
PORTFOLIO = [
    "TMPV", "PACEDIGITK", "CHAMBLFERT", "ETERNAL", "SERVOTECH", "COCHINSHIP",
    "SUZLON", "TRENT", "ARE&M", "M&M", "SWIGGY", "IREDA", "TATAPOWER", "GAIL",
